...
5.  Archive the project on Honeybook, Harvest, Monday, and Google Drive.

6.  If the potential for a new project with the client in the next 3 months is low, archive the Slack channel.

7.  Send the client a Google Form to review our process and performance.

8.  Set up an internal debrief meeting with the team with an agenda.